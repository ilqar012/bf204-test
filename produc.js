...
// // Task2
// const rateFilter1 = ArrProduct.filter((product) => product.rating.rate > 3);
// console.log(rateFilter1);

// // TAsk3
// const rateFilter2 = ArrProduct.filter((product) => product.rating.rate > 3).reduce((total, product) => {
//     return total + product.price
// }, 0);
// console.log(rateFilter2);
...
// let herf = arr.filter((array) =>
//   array.name.trim().toLowerCase().startsWith("t".trim().toLowerCase())
// );
// console.log(herf);
...
// let res = arr.filter(
//   (number) =>
//     number.name.trim().toLowerCase().startsWith("t".trim().toLowerCase()) &&
//     number.name.trim().toLowerCase().endsWith("t".trim().toLowerCase())
// );
// console.log(res);
...
// let sum = res.reduce((sum, item) => sum + item.key, 0);
// console.log("sum: ", sum);
...
// arr.forEach(Obyect);
// function Obyect(item) {
//   if (item.name.trim().toLowerCase().endsWith("e".trim().toLowerCase())) {
//     item.name = "SuperDev";
//   } else {
//   }
// }
...
// let sortName = [...arr];
// sortName.sort((x, y) => x.name.length - y.name.length);
// console.log(sortName[sortName.length - 1]);
...
// console.log(sortName[sortName.length - 1].key);
...
// console.log(arr.indexOf(sortName[sortName.length - 1]) ** 2);
...
// let sortKey = [...arr];
// sortKey.sort((x, y) => x.key.length - y.key.length);

// console.log(sortKey[sortKey.length - 1].name);
...
// 11) keylərin cəmini tapın

// let sum = arr.reduce((sum, item) => sum + item.key, 0);
// console.log("sum: ", sum);

// ==============================================================================================================================================

// 12) terkibinde ən az 2 't' herfi olan obyekt(ler)i tapın.
